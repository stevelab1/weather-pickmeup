  ...
  if ("geolocation" in navigator) {
    ...
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      var queryURL =
        ...
        "&longitude=" +
        longitude +
        "&hourly=temperature_2m,rain&daily=temperature_2m_max,temperature_2m_min,apparent_temperature_max,apparent_temperature_min,precipitation_hours&current_weather=true&timezone=auto&current_weather=true";
